...
import java.sql.*;
import java.util.*;
//create Signup class that extends JFrame class and implements ActionListener
public class Signup extends JFrame implements ActionListener{
    ...
    Random ran = new Random();//for random number generation
    ...
    Signup(){
        ...
        groupmaritalstatus.add(r3);
        groupmaritalstatus.add(r4);
        groupmaritalstatus.add(r5);
