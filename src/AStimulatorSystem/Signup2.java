...
import javax.swing.*;
import java.sql.*;
//create Signup2 class that extends JFrame class and implements ActionListener
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(){
        ...
        setTitle("NEW ACCOUNT APPLICATION FORM - PAGE 2");//title
        ...
        getContentPane().setBackground(Color.WHITE);//for the white background
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                String q1 = "insert into signup2 values('"+formno+"','"+religion+"','"+category+"','"+income+"','"+education+"','"+occupation+"','"+pan+"','"+aadhar+"','"+scitizen+"','"+account+"')";
                c1.s.executeUpdate(q1);//updates the data in the database
