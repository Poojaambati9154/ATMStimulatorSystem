...
import javax.swing.*;
import java.sql.*;
//create Pin class that extends JFrame class and implements ActionListener
        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    JOptionPane.showMessageDialog(null, "Re-Enter Current PIN");
