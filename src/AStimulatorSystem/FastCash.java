...
//create FastCash class that extends JFrame class and implements ActionListener
public class FastCash extends JFrame implements ActionListener {
    ...
    FastCash() {
        ...
        getContentPane().setBackground(Color.WHITE);//This is to get the background in white
    ...
    public void actionPerformed(ActionEvent ae) {
         ...
         if(ae.getSource()==b1){
            ...
            conn c1 = new conn();//database connection
            ResultSet rs = c1.s.executeQuery("select * from bank where pin = '"+a+"'");//to retrive the data from the database
            ...
            if(rs.next()) {
                String pin = rs.getString("pin");
                    ...
                    c1.s.executeUpdate(q1);//updates the content in the database
            ...
            conn c1 = new conn();
            ResultSet rs = c1.s.executeQuery("select * from bank where pin = '"+a+"'");//to get the content from the database
