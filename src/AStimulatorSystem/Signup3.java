...
import java.sql.*;
import java.util.*;
//create Signup3 class that extends JFrame class and implements ActionListener
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(){
        ...
        setTitle("NEW ACCOUNT APPLICATION FORM - PAGE 3");//title
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    c1.s.executeUpdate(q1);//updates data in the database
