...
import javax.swing.*;
import java.sql.*;
//create Withdrawl class that extends JFrame class and implements ActionListener
public class Withdrawl extends JFrame implements ActionListener{
    ...
    Withdrawl(){
        ...
        getContentPane().setBackground(Color.WHITE);//for white background
        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")){
                    ...
                    conn c1 = new conn();//database conection
                    
                    ResultSet rs = c1.s.executeQuery("select * from bank where pin = '"+b+"'");//to retrive the data from the database
                    double balance = 0;
                    if(rs.next()){
